...
Recorded Review uses a bounded one-frame formal-angle cache. Same-frame redraws reuse readonly results; frame/dataset/video/profile identity changes replace or invalidate the single entry.
...
- Focused Recorded Review cache tests: **PASS**, 1 file / 6 tests.
- Task 77–81, Capture/Review lifecycle/layout/publication regressions: **PASS**, 11 files / 108 tests.
- Complete frontend suite: **PASS**, 57 files / 348 tests.
