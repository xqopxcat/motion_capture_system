...
| Ready | prepared | near-full-screen mobile live workspace, Record dominant | camera + latest valid skeleton; shared contain projection; display toggle | none | unprotected; diagnostics gated | stage/render tests | Automated PASS; physical alignment revalidation required |
